...
- Next: rebuild final image containing `0acccf6`, rerun with `--run --reuse=e7b779ba-5758-4b40-aa32-b762d9d46bd3` WITHOUT `--test-working-library`, then full verification/browser suite. Mark #247 ready only after final-image checks. No new merge approval.
