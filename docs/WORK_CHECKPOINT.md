...
- Review PR: [#315](https://github.com/sefaction/MTG-Archives/pull/315), application-free planning commit `b040745` plus this handoff. Internal planning links/code fences and original input copy hashes checked; all nine changed files are Markdown. Authored docs pass whitespace checks; the verbatim research retains its original Markdown hard breaks. Required Core check is tracked in the PR; no merge approval.
