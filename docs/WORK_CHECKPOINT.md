...
- Active branch `perf/inventory-render-pipeline`, application commit `59f7a23`, addresses residual #220/#224. Shared comparators reuse Intl.Collator with original locale/options rather than constructing localeCompare options per comparison. No data/query/scope changes.
...
- Eight repeated private/public expression and color regression cases passed. Four fresh-context after timings: 2790/3205/2254/2244 ms versus 4644/3379/3782/3783 before (median about 33% lower). Logs: `sort-search-regression.log`, `inventory-pipeline-after.log`. Full verify currently runs to `test-results/sort-verify.log`; reconcile processes/results before continuing.
