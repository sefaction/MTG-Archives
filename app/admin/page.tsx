...
const inputClass =
  "min-w-0 rounded-md border border-[#364139] bg-[#0d1210] px-3 py-2 text-sm text-stone-100 outline-none placeholder:text-stone-500 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/25";
...
export default async function Page({
  ...
  const view = params.view === "users" ? "users" : "overview";
      ...
      {view === "overview" ? (
        <>
          ...
          <section className={panelClass}>
            ...
            <details className="p-4">
              ...
              <dl className="grid gap-3 pt-4 text-sm md:grid-cols-3">
                {[
        ...
        <>
          <section className={panelClass}>
            <details>
              <summary
                className={`${panelHeaderClass} cursor-pointer list-none`}
              >
                <span className="flex flex-wrap items-center justify-between gap-3">
                  <span>
                    ...
                    <span className="block text-sm text-stone-400">
                      Add a local login and automatically link an inventory
                      owner.
                    </span>
                  </span>
          ...
          <section className={panelClass}>
            ...
            <form
              method="get"
              className="flex flex-wrap items-end gap-3 border-b border-[#2a332d] p-4"
            >
              ...
              <button className={buttonClass}>Search users</button>
              {query ? (
                <a href="/admin?view=users" className={buttonClass}>
                  Clear search
                </a>
              ) : null}
