...
export function WishlistSearchAdd() {
  ...
  return (
    <details className="group rounded border border-zinc-800">
      <summary className="flex cursor-pointer list-none flex-wrap items-center justify-between gap-3 p-4 hover:bg-zinc-900/50">
        <span className="text-xl font-semibold">
          Add a manual wishlist card
        </span>
        <span className="text-sm text-zinc-400">
          Search a printing, then set quantity and preferences.
        </span>
      </summary>
