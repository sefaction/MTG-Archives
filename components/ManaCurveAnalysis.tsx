    ...
    <div className="space-y-4">
      ...
      <section className="app-panel space-y-4 p-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h2 className="text-xl font-semibold text-stone-100">Mana curve</h2>
        ...
        <div className="overflow-x-auto rounded-lg border border-[#252e29] bg-[#0a0e0c]">
          ...
          >
            ...
            <desc id="mana-curve-description">
              Quantity of permanents and nonpermanent spells at each mana value.
              Each bar is keyboard selectable.
            </desc>
            {[0, 0.5, 1].map((ratio) => {
      ...
      <section className="app-panel p-4" aria-live="polite">
